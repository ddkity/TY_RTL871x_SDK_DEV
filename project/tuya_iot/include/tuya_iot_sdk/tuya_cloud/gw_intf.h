...
#define CDT_RF433_MOD 4 // push cloud add 
...
typedef struct {
    ...
    USHORT_T cir_rept_item_lmt; // admitting report to cloud items in circle(tiem == time_lmt)
...
#define GRP_LMT 10 // group limit
#define SCENE_LMT 10 // scene limit
...
typedef struct {
    BOOL_T get_prt; // is get prevent replay time
...
#if WIFI_GW
/***********************************************************
*  Function: gw_wifi_reset 
*  Input: 
*  Output: 
*  Return: 
***********************************************************/
__GW_INTF_EXT \
OPERATE_RET gw_wifi_reset(IN CONST WF_RESET_TP_T rst_t);
...
***********************************************************/
__GW_INTF_EXT \
DP_CNTL_S *get_dev_dp_cntl(IN CONST DEV_CNTL_N_S *dev_cntl,IN CONST BYTE_T dpid);
...
***********************************************************/
__GW_INTF_EXT \
BOOL_T mq_conn_permit_by_prt(VOID);
...
***********************************************************/
__GW_INTF_EXT \
OPERATE_RET gw_very_pcmcd_mcd(IN CONST UINT_T cmd_from,IN CONST UINT_T seq);
...
***********************************************************/
__GW_INTF_EXT \
VOID force_reg_gw_ug_cb(IN CONST GW_UG_INFORM_CB ug_cb);

#if WIFI_GW
/***********************************************************
*  Function: gw_wifi_nw_cfg_ap_pri_set
*  Input: ap_pri
*  Output: none
*  Return: none
...
***********************************************************/
__GW_INTF_EXT \
VOID gw_wifi_nw_cfg_ap_pri_set(IN CONST BOOL_T ap_pri);
...
***********************************************************/
__GW_INTF_EXT \
OPERATE_RET gw_subdevice_update(IN CONST CHAR_T *id,IN CONST CHAR_T *ver);
...
***********************************************************/
__GW_INTF_EXT \
DEV_DESC_IF_S *gw_dev_traversal(INOUT VOID **iterator);
